...
// let serverUrl ='http://127.0.0.1:88'
// Config.sqrules.query = serverUrl + '/sqrules/query';
// Config.sqrules.save = serverUrl + '/sqrules/save';
// Config.sqrules.getBillType = serverUrl + '/sqrules/getBillType'
// Config.sqrules.queryRefJSON = serverUrl + '/sqrules/queryRefJSON'
